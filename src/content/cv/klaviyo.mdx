[Klaviyo](https://www.klaviyo.com/) is an ecommerce marketing and analytics startup that uses Django. The web app
...
I was responsible for creating and improving data ingestion pipelines for several external platforms. I contributed to
...
products, their categories, and product-related subscriptions. We ported our infrastructure into a boilerplate repo that
several teams used to build their own microservices.
